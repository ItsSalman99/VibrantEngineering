                                ...
                                <div class="pb-5 mb-4 mt-5 mt-lg-0">
                                    <div
                                        ...
                                        <img width="105" height="105"
                                            src="img/demos/business-consulting-3/icons/map-pin.svg" alt="Location" data-icon
                                    ...
                                    <div class="col-auto text-center pt-4 mt-5">
                                        ...
                                        <div class="d-flex">
                                            <img width="25" height="25"
                                                ...
                                                data-icon
                                                data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary'}" />
                                            <a href="https://www.okler.net/cdn-cgi/l/email-protection#90f3fffee4f1f3e4d0e0ffe2e4ffe4f8f5fdf5bef3fffd"
                                                class="text-color-dark text-color-hover-primary text-decoration-underline font-weight-semibold text-5-5 wb-all ms-2"><span
                                                    class="__cf_email__"
                                                    data-cfemail="fd9e9293899c9e89bd8d928f89928995989098d39e9290">[email&#160;protected]</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
