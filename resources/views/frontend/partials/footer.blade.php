    ...
    <div class="container pt-3">
        <div class="row justify-content-between align-items-center py-5 mb-3">
            <div class="col-auto mb-4 mb-lg-0">
                <h2 class="font-weight-semibold text-color-light text-10 ls-0 mb-0">
                    Vibrant Engineering
                </h2>
            </div>
            <div class="col-auto">
            ...
            <div class="col-lg-3 mb-4 mb-lg-0">
                ...
                <ul
                    ...
                    <li class="social-icons-facebook"><a href="http://www.facebook.com/" target="_blank"
                            title="Facebook" data-cursor-effect-hover="fit"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <li class="social-icons-linkedin"><a href="http://www.linkedin.com/" target="_blank"
                            title="Linkedin" data-cursor-effect-hover="fit"><i class="fab fa-linkedin-in"></i></a></li>
                </ul>
            </div>
            <div class="col-lg-3 mb-4 mb-lg-0">
                <ul class="list list-icons list-icons-lg">
                    ...
                    <li class="d-flex px-0 my-3">
                        <img width="25" src="img/demos/business-consulting-3/icons/email.svg" alt="Email Icon"
                            data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" />
                        <a href="https://www.okler.net/cdn-cgi/l/email-protection#81f1eef3f5eec1f1eef3f5eef5e9e4ece4afe2eeec"
                            class="text-color-light font-weight-semibold text-3-4 ms-2"><span class="__cf_email__"
                                data-cfemail="0b7b64797f644b7b64797f647f636e666e25686466">[email&#160;protected]</span></a>
                    </li>
            ...
            <div class="col-lg-2">
                ...
                <ul class="list list-icons list-icons-sm">
                    <li>
                        ...
                        <a href="demo-business-consulting-3-contact.html" class="link-hover-style-1 ms-1">
                            Contact Us</a>
                    </li>
                    <li>
                        <i class="fas fa-angle-right text-color-default"></i>
                        <a href="demo-business-consulting-3-services.html" class="link-hover-style-1 ms-1">
                            Our Services</a>
                    </li>
                    <li>
                        <i class="fas fa-angle-right text-color-default"></i>
