            ...
            <div class="container pb-5 my-3">
                <div class="row mb-4">
                    <div class="col-md-12 align-self-center p-static order-2 text-center">
                        <h1 class="font-weight-bold text-color-dark text-10">Privacy & Policy</h1>
                    </div>
        ...
        <div class="container pt-3 mt-4">
            <div>
                <h2 class="text-9 text-lg-5 text-xl-9 line-height-3 text-transform-none font-weight-semibold mb-4 mb-lg-3 mb-xl-4 appear-animation"
                    ...
                    Privacy & Policy For Vibrant Engineering
                </h2>
                ...
                <p class="mb-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750">
                    Curabitur vulputate posuere tortor luctus vulputate. Cras laoreet
